...
@usuarios_api.route('/usuarios/<int:usuario_id>', methods=['GET'])
@jwt_required()
...
@usuarios_api.route('/usuarios/<int:usuario_id>', methods=['PUT'])
@jwt_required()
...
@usuarios_api.route('/usuarios/<int:usuario_id>/baja', methods=['PUT'])
@jwt_required()
...
@usuarios_api.route('/usuarios/<int:usuario_id>/hacer-admin', methods=['PUT'])
@jwt_required()
